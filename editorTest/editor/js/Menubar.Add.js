...
import {point, circle, segment,polygon, vector, line, multiline} from "https://unpkg.com/@flatten-js/core?module";
...
function MenubarAdd( editor ) {
	...
	option = new UIRow();
	option.setClass( 'option' );
	option.setTextContent( strings.getKey( 'menubar/add/polygon' ) );
	option.onClick( function () {
		// Heart
		const x = 0, y = 0;
		...
		mesh.userData.polygon= res_poly;
